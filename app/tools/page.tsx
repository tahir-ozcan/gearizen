...
export const metadata = {
  ...
  description:
    "Explore Gearizen’s 100% client-side toolbox: password & bcrypt generators, JSON tools, QR code creator, unit converter, image compressor & resizer, contrast checker, Base64 encoding, markup formatter, regex tester, diff checker, timestamp converter, PDF and CSV utilities, SEO & OG tag generators, JWT decoder, and more—all free, no signup.",
  keywords: [
    "free online tools",
    "client-side tools",
    "password generator",
